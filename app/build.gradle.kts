...
dependencies {
    ...
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.6.0")// Use the latest stable version
    testImplementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.6.0") // Use the latest stable version
}